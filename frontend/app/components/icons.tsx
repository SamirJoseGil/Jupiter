...
// Colección de iconos SVG reutilizables para la aplicación

export const AccessibilityIcon = ({ className = "w-6 h-6" }) => (
  <svg className={className} fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    <path d="M12 2C10.9 2 10 2.9 10 4s.9 2 2 2 2-.9 2-2-.9-2-2-2m9 7h-6v13h-2v-6h-2v6H9V9H3V7h18v2z" />
  </svg>
);

export const FormIcon = ({ className = "w-6 h-6" }) => (
  <svg className={className} fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
export const SpeedIcon = ({ className = "w-6 h-6" }) => (
  <svg className={className} fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    <path d="M20 8h-3V4H3c-1.1 0-2 .9-2 2v11h2c0 1.66 1.34 3 3 3s3-1.34 3-3h6c0 1.66 1.34 3 3 3s3-1.34 3-3h2v-5l-3-4zM5.5 18.5c-.83 0-1.5-.67-1.5-1.5s.67-1.5 1.5-1.5 1.5.67 1.5 1.5-.67 1.5-1.5 1.5zm12.5-7h-7V9h7v2.5zm0 0l2.5-3.5h2.5v2.5h-5zm-.5 6.5c-.83 0-1.5-.67-1.5-1.5s.67-1.5 1.5-1.5 1.5.67 1.5 1.5-.67 1.5-1.5 1.5z" />
  </svg>
);
...
export const PhoneIcon = ({ className = "w-6 h-6" }) => (
  <svg className={className} fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    <path d="M17.92 7.02C17.45 6.18 16.51 5.55 15.46 5.55c-2.64 0-4.81 3.06-4.81 6.82 0 3.76 2.17 6.82 4.81 6.82 1.05 0 1.99-.63 2.46-1.47.33.67.77 1.27 1.3 1.77-1.02.89-2.11 1.57-3.76 1.57-4.29 0-7.75-3.5-7.75-7.92s3.46-7.92 7.75-7.92c1.65 0 2.74.68 3.76 1.57-.53.5-.97 1.1-1.3 1.77zM19 8h4v8h-4z" />
  </svg>
);
